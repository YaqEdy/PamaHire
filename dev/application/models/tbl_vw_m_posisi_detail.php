...
class tbl_vw_m_posisi_detail extends CI_Model {
  var $table = 'tbl_vw_m_posisi_detail';
  var $column = array('pid','pid_posisi','pid_jurusan','min_gpa','jurusan_desc','created_by','created_date','last_update_by','last_update_date');
  ...
  public function get_by_selected($pid_posisi)
	{
		$this->db->from($this->table);
