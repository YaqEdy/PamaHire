...
<div class="navbar  navbar-default navbar-light" style="background-color:#26c6da;position:relative;z-index:50;box-shadow:5px 0px 10px rgba(0,0,0,0.5)" role="navigation">
  <div class="container" >
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="<?php echo base_url() ;?>"><img style="width:55px;height:60px;margin: 0 auto !important" src="<?php echo base_url().'templates/frontend/images/' ;?>logopama.png"  alt="Logo PAMA"></a>
    ...
    <div class="collapse navbar-collapse cust-nav navbar-right" id="myNavbarMain">
      ...
      <ul class="nav navbar-nav">
        <li><a style="color:white;font-size:14px" href="<?php echo base_url()?>"><i class="glyphicon glyphicon-home"></i></a></li>
    ...
    <div class="container">
      <ul class="mainnav">
        <?php if($user_session['menu'] == 'dashboard'){ ?>
              <li class="active"><a href="<?=set_url('dashboard/admin');?>"><i class="glyphicon glyphicon-dashboard" style="color:#26c6da"></i><span>Dashboard</span> </a> </li>
              <?php } else { ?>
              <li><a href="<?=set_url('dashboard/admin');?>"><i class="glyphicon glyphicon-dashboard" style="color:#26c6da"></i><span>Dashboard</span> </a> </li>
              <?php } ?>
        <?php if($user_session['menu'] == 'rekrutmenadmin'){ ?>
              <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-file"style="color:#26c6da"></i><span>Rekrutmen</span> <b class="caret"></b></a>
              <?php } else { ?>
              <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-file"style="color:#26c6da"></i><span>Rekrutmen</span> <b class="caret"></b></a>
              <?php } ?>

          <ul class="dropdown-menu">
            <li><a href="<?=set_url('m_jurusan');?>">Master Jurusan</a></li>
            <li><a href="<?=set_url('m_posisi');?>">Master Posisi Lowongan</a></li>
            <li><a href="<?=set_url('position');?>">Master Posisi</a></li>
            <li><a href="<?=set_url('source');?>">Master Source</a></li>
            <li><a href="<?=set_url('t_rekrutmen');?>">Kelola Rekrutmen</a></li>
          </ul>
        </li>

        <?php if($user_session['menu'] == 'seleksi'){ ?>
              <li class="active"><a href="<?=set_url('seleksiadministrasi');?>"><i class="glyphicon glyphicon-list-alt" style="color:#26c6da"></i><span>Seleksi Administrasi</span> </a> </li>
              <?php } else { ?>
              <li><a href="<?=set_url('seleksiadministrasi');?>"><i class="glyphicon glyphicon-list-alt" style="color:#26c6da"></i><span>Seleksi Administrasi</span> </a> </li>
              <?php } ?>

        <!-- <?php if($user_session['menu'] == 'akun'){ ?>
              <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user" style="color:#00838f"></i><span>User</span> <b class="caret"></b></a>
              <?php } else { ?>
              <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user" style="color:#00838f"></i><span>User</span> <b class="caret"></b></a>
              <?php } ?>
        ...
        <?php if($user_session['menu'] == 'blacklist'){ ?>
              <li class="active"><a href="<?=set_url('blacklist');?>"><i class="glyphicon glyphicon-ban-circle" style="color:#26c6da"></i><span>Black list</span> </a> </li>
              <?php } else { ?>
              <li><a href="<?=set_url('blacklist');?>"><i class="glyphicon glyphicon-ban-circle" style="color:#26c6da"></i><span>Black list</span> </a> </li>
              <?php } ?>
        <li><a href="<?=set_url('user/logout');?>"><i class="glyphicon glyphicon-off" style="color:#26c6da"></i><span>Logout</span> </a> </li>
