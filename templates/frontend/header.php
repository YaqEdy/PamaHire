  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <?php } else { ?>
        <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i><span>User</span> <b class="caret"></b></a>
        <?php } ?>
            <ul class="dropdown-menu">
              <li><a href="<?=set_url('user/logout');?>">Logout</a></li>
            </ul>
        </li> -->
        <li><a href="<?=set_url('user/logout');?>"><i class="glyphicon glyphicon-off" style="color:#00838f"></i><span>Logout</span> </a> </li>
        <!-- <li class="dropdown"><a href="<?=set_url('produk/index');?>" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i><span>User</span>  <b class="caret"></b></a>
          <ul class="dropdown-menu">
            <li><a href="<?=set_url('user/logout');?>">Daftar Produk</a></li>
          </ul>
        </li> -->
      </ul>
    </div>
